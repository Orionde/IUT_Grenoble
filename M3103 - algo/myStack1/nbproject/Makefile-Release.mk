...
${OBJECTDIR}/_ext/1977059626/PrecondVioleeExcep.o: ../TP321/TP3.2.1/PrecondVioleeExcep.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1977059626/PrecondVioleeExcep.o ../TP321/TP3.2.1/PrecondVioleeExcep.cpp

${OBJECTDIR}/_ext/1977059626/bienparenthesee.o: ../TP321/TP3.2.1/bienparenthesee.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1977059626
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1977059626/bienparenthesee.o ../TP321/TP3.2.1/bienparenthesee.cpp

${OBJECTDIR}/_ext/1977059626/premiercontact.o: ../TP321/TP3.2.1/premiercontact.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1977059626
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1977059626/premiercontact.o ../TP321/TP3.2.1/premiercontact.cpp
