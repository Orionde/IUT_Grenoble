...
${OBJECTDIR}/NomIncorrectException.o: NomIncorrectException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NomIncorrectException.o NomIncorrectException.cpp
...
${OBJECTDIR}/SalarieException.o: SalarieException.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SalarieException.o SalarieException.cpp
