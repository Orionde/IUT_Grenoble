...
void testeEstInfoPresentRec(){
    cout << "DEBUT testeEstInfoPresente" << endl << endl;
    ListeChainee<string> uneListe;
    cout << "Insertion de zéro, un, deux, trois, quatre, cinq aux positions repectives 1, 2, 3, 4, 5" << endl;
    string items[] = {"zéro", "un", "deux", "trois", "quatre", "cinq"};
    for (int i = 0; i < 6; i++) {
    ...
    cout << "On teste si on trouve la valeur \"deux\" dans la liste" << endl;
    string argument = "deux";
    bool test = uneListe.estInfoPresenteRec(argument);
    if(test)
        cout << "L'info a bien été trouvée" << endl;
    else
        cout << "info non trouvée" << endl;
    
    cout << "On teste si on trouve la valeur \"gfdsgfdsgf\" dans la liste" << endl;
    argument = "gfdsgfdsgf";
    test = uneListe.estInfoPresenteRec(argument);
    if(test)
        cout << "L'info a bien été trouvée" << endl;
    else
        cout << "info non trouvée" << endl;
